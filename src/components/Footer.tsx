            ...
            <footer className="fixed bottom-0 inset-x-0 max-w-xl mx-auto bg-gray-700 text-white py-2 opacity-95 z-50">
                ...
                <div className="container mx-auto max-w-xl flex items-center px-4 justify-between">
                    ...
                    <div className="text-md">
                        <strong>¥ {formatBigIntWithSuffix(currency)}</strong>
                    </div>

                    {/* Hamburger menu in the center */}
                    <div className="flex-shrink-0 absolute left-1/2 transform -translate-x-1/2">
                        {isMenuOpen && (
                            <div className="absolute bottom-14 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white w-48 rounded-lg shadow-lg z-50">
                        ...
                        <button
                            className="flex flex-col items-center justify-center w-10 h-10 bg-gray-600 rounded-md hover:bg-gray-500 transition"
                            aria-label="Menu"
                    ...
                    <div className="flex items-center ml-auto space-x-2">
                        {readyBusinessesCount > 0 && (
                            <button
                                ...
                                className="relative bg-red-600 text-white min-w-12 px-3 py-2 rounded hover:bg-red-700 transition"
                            >
                        ...
                        <button
                            ...
                            className="bg-blue-500 text-white px-3 min-w-16 py-2 rounded hover:bg-blue-600 transition"
                        >
                            {purchaseAmount}
                        </button>
                    </div>
