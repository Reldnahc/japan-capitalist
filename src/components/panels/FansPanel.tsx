...
const FansPanel: React.FC<FansPanelProps> = ({ currentFans, totalFans, onClaimFans }) => {
    ...
    return (
            <div className={`h-[70vh] overflow-y-auto px-6 pb-6 flex flex-col gap-6 items-center rounded-lg scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-800`}>
