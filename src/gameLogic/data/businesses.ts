...
export const businesses: Business[] = [
    ...
    new Business("Pachinko", BigInt(4050000), BigInt(80840), 1.10, 30000, pachinkoUnlocks, 0, pachinkoManager),
    new Business("Video Games", BigInt(81000000), BigInt(455800), 1.10, 60000, videoGamesUnlocks, 0, videoGamesManager),
