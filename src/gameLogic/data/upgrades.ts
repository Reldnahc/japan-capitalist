...
export const burgerUpgrades: Upgrade[] = [
    ...
    { name: "Revenue", cost: 1200000000000n, effect: "Revenue ×6", unlocked: false },
];
...
export const sushiUpgrades: Upgrade[] = [
    ...
    { name: "Revenue", cost: 9500000000000n, effect: "Revenue ×5", unlocked: false },
];
...
export const convenienceUpgrades: Upgrade[] = [
    ...
    { name: "Revenue", cost: 20000000000000n, effect: "Revenue ×5", unlocked: false },
];
...
export const pachinkoUpgrades: Upgrade[] = [
    ...
    { name: "Revenue", cost: 950000000000000n, effect: "Revenue ×6", unlocked: false },
];
...
export const videoGamesUpgrades: Upgrade[] = [
    ...
    { name: "Revenue", cost: 5000000000000000n, effect: "Revenue ×5", unlocked: false },
];
...
export const tvUpgrades: Upgrade[] = [
    ...
    { name: "Revenue", cost: 90000000000000000n, effect: "Revenue ×6", unlocked: false },
];
...
export const carsUpgrades: Upgrade[] = [
    ...
    { name: "Revenue", cost: 5000000000000000000n, effect: "Revenue ×6", unlocked: false },
];
...
export const idolsUpgrades: Upgrade[] = [
    ...
    { name: "Revenue", cost: 500000000000000000000n, effect: "Revenue ×6", unlocked: false },
];