...
export const takoyakiUpgrades: Upgrade[] = [
    ...
    { name: "Efficiency", cost: 500000n,         effect: "Speed +100%", unlocked: false },
    { name: "Revenue",    cost: 1500000n,        effect: "Revenue ×2",  unlocked: false },
    ...
    { name: "Revenue",    cost: 500000000000n,   effect: "Revenue ×4",  unlocked: false },
];

export const ramenUpgrades: Upgrade[] = [
    { name: "Efficiency", cost: 50000n,          effect: "Speed +100%", unlocked: false },
    { name: "Efficiency", cost: 725000n,        effect: "Speed +100%", unlocked: false },
    { name: "Revenue",    cost: 2500000n,       effect: "Revenue ×2",  unlocked: false },
    { name: "Efficiency", cost: 3250000000n,    effect: "Speed +100%", unlocked: false },
    { name: "Revenue",    cost: 455000000000n,  effect: "Revenue ×3",  unlocked: false },
...
export const burgerUpgrades: Upgrade[] = [
    ...
    { name: "Revenue",    cost: 80000000000n,   effect: "Revenue ×3",  unlocked: false },
    { name: "Revenue",    cost: 1200000000000n, effect: "Revenue ×4",  unlocked: false },
];
...
export const sushiUpgrades: Upgrade[] = [
    ...
    { name: "Revenue",    cost: 9500000000000n, effect: "Revenue ×4",  unlocked: false },
];
...
export const convenienceUpgrades: Upgrade[] = [
    ...
    { name: "Revenue",    cost: 32000000000n,    effect: "Revenue ×2",  unlocked: false },
    { name: "Efficiency", cost: 420000000000n,   effect: "Speed +100%", unlocked: false },
    { name: "Revenue",    cost: 8400000000000n,  effect: "Revenue ×3",  unlocked: false },
    { name: "Revenue",    cost: 20000000000000n, effect: "Revenue ×4", unlocked: false },
];
...
export const pachinkoUpgrades: Upgrade[] = [
    ...
    { name: "Revenue",    cost: 950000000000000n, effect: "Revenue ×4", unlocked: false },
];
...
export const videoGamesUpgrades: Upgrade[] = [
    ...
    { name: "Revenue",    cost: 5000000000000000n, effect: "Revenue ×4", unlocked: false },
];
...
export const tvUpgrades: Upgrade[] = [
    ...
    { name: "Revenue",    cost: 90000000000000000n, effect: "Revenue ×4", unlocked: false },
];
...
export const carsUpgrades: Upgrade[] = [
    ...
    { name: "Revenue",    cost: 5000000000000000000n, effect: "Revenue ×4", unlocked: false },
];
...
export const idolsUpgrades: Upgrade[] = [
    ...
    { name: "Revenue",    cost: 500000000000000000000n, effect: "Revenue ×4", unlocked: false },
];